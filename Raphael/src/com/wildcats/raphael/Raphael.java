...
public class Raphael extends SimpleRobot {
    ...
    Victor leftfrontvic = new Victor(in.leftfrontdrive);
    Victor rightfrontvic = new Victor(in.rightfrontdrive);
    Victor leftrearvic = new Victor(in.leftreardrive);
    Victor rightrearvic = new Victor(in.rightreardrive);
